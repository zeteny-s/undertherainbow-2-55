      ...
      <div className="max-w-7xl mx-auto px-4 py-8 animate-fade-in">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary-hover transition-all duration-200 hover-lift text-sm font-medium"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-surface border border-DEFAULT rounded-lg hover:bg-surface-hover transition-all duration-200 hover-lift text-sm font-medium text-foreground"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-surface-elevated border border-DEFAULT rounded-xl p-6 hover-lift">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-surface-elevated border border-DEFAULT rounded-xl p-6 hover-lift">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-2xl font-semibold text-foreground">{assignedPedagogus}</p>
          ...
          <div className="p-6">
            {classes.length === 0 ? (
              <div className="text-center py-16 animate-fade-in">
                ...
                <button
                  onClick={() => setShowCreateModal(true)}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary-hover transition-all duration-200 hover-lift font-medium"
                >
                  <Plus className="w-4 h-4" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {classes.map((cls, index) => (
                  <div
                    ...
                    className="group p-6 border border-DEFAULT rounded-xl hover:border-border-hover cursor-pointer transition-all duration-200 hover-lift bg-white animate-slide-in-right"
